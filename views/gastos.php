            ...
            <div class="tab-pane fade mb-5" id="registrar" role="tabpanel" aria-labelledby="registrar-tab">
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <select class="form-control" id="semana" name="tipo">
                                </select>
                            </div>
                            <div class="col-md-2">
                                <button type="button"  class="btn btn-outline-success mb-3" onclick="agregarCampos()">Agregar Campos</button>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="gasto-editar" name="precio" placeholder="Precio">
                            <label for="precio" class="form-label">Gasto</label>
                        </div>
                    </div>

                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <select class="form-control" name="" id="tipo-editar">
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-floating mb-3">
                            <select class="form-control" name="" id="semana-editar">
                            </select>
                        </div>
                    </div>
                ...
                <button type="button" id="editar-gasto"  class="btn btn-outline-primary">Editar</button>
